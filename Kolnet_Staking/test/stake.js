...
describe("Greeter", function () {
  it("Should deploy staking", async function () {
    ...
    const pro = await ethers.getContractFactory("Stake");
    stake = await pro.deploy("0xFcce5CE96D091395bef9f9c19306983e4D812c10", token.address);
  ...
  it("should stake KOL TOKENS", async function() {
    await stake.stakeTokens(token.address, web3.utils.toWei("100"));
  });
